...
<head>
    ...
    <!-- Page title -->
    <title>О Нас | Команда Tactile Track</title>
        ...
        <div class="sections desktop">
            ...
            <div class="center">
                <ul class="menu uppercase">
                   <li><a href="#" class="popupTrigger" data-popup-id="10-0">Посмотреть видео</a></li>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-8-12">
                    	<h3>На сегодняшний день инновационная технология Tactile Track защищена двумя патентами, выданными Федеральной службой по интеллектуальной собственности.</h3>
