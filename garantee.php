    ...
    <nav class="panel top small forceMobileView">
        <div class="sections desktop">
            ...
            <div class="right">
                ...
                <span class="button actionButton tel-btn">
                	<span>
                		<svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-phone"></use></svg>
                	</span>
                	<div class="tel-btn_drop">
                		<a class="tel-btn_number" href="tel:+78126484275">+7 (812) 648-4275</a>
                		<a class="tel-btn_call" href="tel:+78126484275">Позвонить</a>
                	</div>
                </span>
    ...
    <nav class="sidebar blueGrey" data-sidebar-id="1">
        ...
        <div class="content">
			...
			<ul class="mainMenu uppercase small">
				<li><a href="index.php#home">Что такое Tactile Track</a></li>
				<li><a href="index.php#HowitWorks">Как он работает</a></li>
				<li><a href="index.php#WhyToBuy">Преимущества</a></li>
				<li><a href="index.php#unique">Технические характеристики</a></li>
