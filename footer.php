...
<div class="popup order-popup" data-popup-id="order-popup">
	<div class="content">
		<div class="container">
			<div class="wrap left top padding-top-8 padding-bottom-4 padding-left-3 padding-right-3">
				<div class="fix-10-12 popupContent padding-top-3 padding-bottom-4 padding-left-3 padding-right-3 checkout-page">
					...
					<div class="col-12-12 checkout-header">
						...
						<div class="checkout-phone small"><strong>+7 (812) 648-4275</strong></div>
					</div>
						...
						<div class="col-6-12">
							...
							<div class="step-row">
								...
								<form id="step_1" class="wide">
									...
									<div class="form-row">
										<input class="form-row_field" id="name_s" type="text" name="name" placeholder="Имя" required="">
									</div>
									<div class="form-row">
										<input class="form-row_field" id="email_s" type="email" name="email" placeholder="E-mail" required="">
							...
							<div class="checkout-cart">
								...
								<div class="checkout-cart_content">
									...
									<div class="checkout-cart_content-left">
										...
										<p class="checkout-amount">1 x 3990 р.</p>
								...
								<div class="checkout-cart_footer">
									<p class="total-amount">Итого: 3990 р.</p>
					...
					<div class="grid fixedSpaces equal fromCenter success-message center" id="form_2">
						...
						<form>
							...
							<div class="form-row">
								<input id="btn-checkout-2" class="button green btn-checkout go_form_2 g-recaptcha" type="submit" value="Отправить сообщение" data-success-text="Спасибо! Ваш заказ принят" data-success-class="green" data-sitekey="6Lc5Yi4UAAAAAJHJ1U87TAMm5sRBeeFSdK2budnS" data-callback="YourOnSubmitFn">
							</div>
    ...
    <!-- Slide #55 -->
    <!--    
    <section class="slide fade kenBurns" name="Order" data-title="Заказать">
        <div class="content">
            <div class="container">
                <div class="wrap">

                    <h1 class="small ae-1">Закажите сейчас и получите скидку 30% </h1>
                    <div class="ae-1">
					...
					<option value="TT02">TT02</option>
                                ...
                                <input class="button wide pink round uppercase ae-10 button-55" type="submit" name="submit" value="Заказать" data-success-text="Принято! Спасибо." data-success-class="green" onClick="onClick()" />
                            </form>
                        </div>
                    </div>
