    ...
    <div class="content">
        <div class="container">
            <div class="wrap left top padding-top-8 padding-bottom-4 padding-left-3 padding-right-3">
                <div class="fix-12-12 popupContent padding-top-7 padding-bottom-7 padding-left-5 padding-right-5 checkout-page">
                   <div class="col-12-12 checkout-header">
                        ...
                        <h4 class="checkout-phone small"> +38 099 111 11 11</h4>
                   </div>
                   <div class="grid fixedSpaces equal fromCenter">
                        <div class="col-7-12">
                            <h3 class="margin-bottom-5 center">Оформление заказа</h3>
                            ...
                            <div class="form-checkout">
                                <form id="contact-form left" action="ajax-email.php" method="post" class="wide">
                                   <div class="form-row">
                                        <input class="stroke wide round" id="name55" type="name" name="name55" placeholder="Имя и фамилия" required="">
                                   </div>
