...
<body class="slides whiteSlide animated">
  ...
  <symbol id="right" viewBox="-2 6 16 16"><path d="M13.7 13.3l-5-5c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4l3.3 3.3h-11.6c-.6 0-1 .4-1 1s.4 1 1 1h11.6l-3.3 3.3c-.4.4-.4 1 0 1.4.2.2.4.3.7.3s.5-.1.7-.3l5-5c.2-.2.3-.5.3-.7s-.1-.5-.3-.7z"/></symbol>
    ...
    <!-- Slide #11 1 -->
    <section class="slide video fade hide-fade animate" name="home" data-title="Что такое Tactile Track">
        <div class="content">
            <div class="container">
                <div class="wrap slide-start">
        ...
        <div class="background"><div class="vsc-controller"></div>
            <video poster="assets/img/rr_1.jpg" loop="true" muted="" class="vsc-initialized" id="top-video">
...
-->
    ...
    <!-- Slide #70 -->
    <section class="slide fade kenBurns" name="Models" data-title="Выбор модели">
        <div class="content">
            <div class="container">
                <div class="wrap">
