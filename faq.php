...
<head>
    ...
    <!-- Page title -->
    <title>FAQ | Браслет-навигатор Tactile Track</title>
...
<body class="slides whiteSlide animated">
  ...
  <symbol id="right" viewBox="-2 6 16 16"><path d="M13.7 13.3l-5-5c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4l3.3 3.3h-11.6c-.6 0-1 .4-1 1s.4 1 1 1h11.6l-3.3 3.3c-.4.4-.4 1 0 1.4.2.2.4.3.7.3s.5-.1.7-.3l5-5c.2-.2.3-.5.3-.7s-.1-.5-.3-.7z"/></symbol>
    ...
    <section class="slide fade kenBurns selected active animate" name="faq" data-title="FAQ">
            <div class="content">
                <div class="container">
                    <div class="wrap">
                        ...
                        <div class="fix-12-12">
                            <div class="grid">
                                <div class="col-10-12 left">
                                    <h1 class="small ae-2 fromRight">Часто задаваемые вопросы</h1>
                                        <div class="ae-3 fromRight margin-botton-5">
                                            <h3>Что входит в комплект браслета Tactile Track?</h3>
                                            <p>Вы получите сам браслет Tactile Track, инструкцию к нему и USB-кабель.</p>
                                            <h3>В чем отличие от навигации часов Apple Watch, которые тоже вибрируют при включенном режиме навигации?</h3>
                                            <p>На браслет Tactile Track не нужно смотреть. Благодаря своей революционной конструкции, он тактильно и естественно понятно указывает направление поворота, а Apple Watch лишь предупреждает пользователя об изменении направления и требует посмотреть на свой маленький экран - куда вам повернуть. Основной задачей, идеей и целью Tactile Track, является именно отсутствие необходимости отвлекаться на экран навигации.</p>
                                            <h3>Какие карты используются для навигации?</h3>
                                            <p>Для отображения карт и составления маршрутов мы используем OpenStreetMaps (www.openstreetmap.org).</p>
                                            <h3>Будет ли Tactile Track работать в моем регионе/стране?</h3>
                                            <p>Если в вашем регионе или стране есть 3G-связь, то приложение будет работать. Большая часть мира покрыта нашей системой. Если у приложения Tactile Track в вашем регионе или стране возникнут проблемы, сообщите нам. Мы хотим знать об этом первыми.</p>
                                            <h3>Почувствую ли я вибрацию браслета, когда мотоцикл будет трясти на дороге?</h3>
                                            <p>Да. Благодаря вибрационным ощущениям человек способен не только устанавливать сам факт наличия или отсутствия вибра­ций, но и различать вибрации по частоте и силе. В среднем на 1 см2 поверхности кожи человека приходится примерно 170 тактильных рецепторов. Поэтому, если вы плотно зафиксировали браслет на руке, вы физически не сможете пропустить вибрационный сигнал.</p>
                                            <h3>Можно ли вернуть браслет после получения, если он не подошел?</h3>
                                            <p>Да, согласно Закону РФ от 7 февраля 1992 г. N 2300-I <a href="http://pravo.gov.ru/proxy/ips/?docbody=&nd=102014512&intelsearch=%E7%E0%EA%EE%ED+%EE+%E7%E0%F9%E8%F2%E5+%EF%F0%E0%E2+%EF%EE%F2%F0%E5%E1%E8%F2%E5%EB%FF"> (в редакции от 3 июля 2016 г.). Если браслет не подойдет вам по цвету, размеру или каким-либо другим причинам, вы можете его вернуть в течении 14 дней с момента получения, после чего мы вернем вам деньги. Подробнее об этом читайте в разделе “<a href="garantee.php">Гарантия</a>”. </p>
                                            <h3>Как отменить заказ браслета?</h3>
                                            <p>Если вы решите отменить свой заказ или хотите вернуть браслет по любой причине, отправьте электронное письмо на info@tactiletrack.com с указанием причины отмены / возврата. Если письмо будет получено до отправления товара, мы отменим ваш заказ и вернем деньги. Если же браслет уже был отправлен, он может быть возвращен вами в течение 14 дней с даты получения. В таком случае мы вернем вам деньги после того, как получим браслет обратно.</p>
                                        </div>
                                </div>
            ...
            <div class="background" style="background-image:url(assets/img/r_12.jpg)"></div>
        </section>
